...
/// <summary>Creates a Win32 "EDIT" control used for text input.</summary>
class TextBox : public Control
{
	...
	public:
		...
		///  <para>Call the event arguments' SetHandle() to prevent the enter key from being processed by the text box.</para>
		/// </summary>
		...
		/// </summary>
		/// <param name="text">The string object to copy the control's placeholder text to.</param>
		/// <returns>
		///  <para>
		...
		/// <summary>Fetches the text box's horizontal string alignment as a Corona string id.</summary>
		/// <returns>Returns the text box's alignment string id such as "left", "center", or "right".</returns>
		const char* GetAlignmentStringId() const;

		/// <summary>Sets the text box's horizontal string alignment.</summary>
		/// <param name="alignmentStringId">The alignment string id such as "left", "center", or "right".</param>
		void SetAlignment(const char* alignmentStringId);

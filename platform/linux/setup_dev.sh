...
#  sudo apk add --no-cache $packagesNeeded
  ...
  sudo apt-get install -y build-essential libwxgtk3.0-gtk3-dev zlib1g-dev libgl1-mesa-dev libglu1-mesa-dev libopenal-dev libpng-dev
  sudo apt-get install -y libcurl4-openssl-dev libpng-dev libssl-dev libvorbis-dev libogg-dev uuid-dev zlib1g-dev 

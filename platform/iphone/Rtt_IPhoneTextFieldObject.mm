...
{
	Rtt::IPhoneTextFieldObject *o = (textField).owner;
	if ( o )
	{
...
DispatchEvent( Rtt_UITextField *textField, int startpos, int numdeleted, const char* replacementstring, const char* oldstring, const char* newstring )
{
	...
	if ( o )
	{
		Rtt::UserInputEvent e( startpos, numdeleted, replacementstring, oldstring, newstring );
		o->DispatchEventWithTarget( e );
	}
}
...
- (BOOL)textField:(UITextField*)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString*)string
{
	...
	// Delay so textField.text reflects the edit.
...
- (void)dispatchEditingEventForTextField:(Rtt_AppleTextDelegateWrapperObjectHelper*)eventData
{
	...
	NSString* string = eventData.replacementString ? eventData.replacementString : @"";
	NSString* oldstring = eventData.originalString ? eventData.originalString : @"";
	NSString* newstring = textField.text ? textField.text : @"";

	DispatchEvent( textField, (int)(range.location + 1), (int)range.length,
		[string UTF8String], [oldstring UTF8String], [newstring UTF8String] );
}

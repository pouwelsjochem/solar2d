...
/// Provides pre-defined window mode types such as "normal", "minimized", "fullscreen".
...
class NativeWindowMode
{
	...
	public:
		...
		/// @param stringId The window mode's unique string ID such as "normal" etc.
		/// @returns Returns a pointer to the matching NativeWindowMode object such as kNormal etc.
		///          <p>

...
void
ClosedPath::ReleaseProxy( LuaUserdataProxy *proxy )
{
    if (proxy)
    {
...
int
ClosedPath::ExtensionAdapter::ValueForKey(
...
bool
ClosedPath::ExtensionAdapter::SetValueForKey(
...
void
ClosedPath::ExtensionAdapter::WillFinalize( LuaUserdataProxy& sender ) const
{
    DisplayObject* object = (DisplayObject*)sender.GetUserdata();
    if (!object) { return; }
...
StringHash *
ClosedPath::ExtensionAdapter::GetHash( lua_State *L ) const
{
...
int
ClosedPath::ExtensionAdapter::getAttributeDetails( lua_State *L )
{
    int result = 0;
    int nextArg = 1;
...
int
ClosedPath::ExtensionAdapter::setAttributeValue( lua_State *L )
{
    int nextArg = 1;

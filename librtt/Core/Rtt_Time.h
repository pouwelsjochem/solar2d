...
#if defined( Rtt_APPLE_ENV ) || defined( Rtt_ANDROID_ENV ) || defined( Rtt_WEBOS_ENV ) || defined( Rtt_EMSCRIPTEN_ENV ) || defined( Rtt_WIN_ENV ) || defined( Rtt_NXS_ENV ) || defined( Rtt_LINUX_ENV )
	#include <stdint.h>
